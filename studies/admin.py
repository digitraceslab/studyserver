...
from .forms import (
    SourceConfigurationInlineForm,
    StudyAdminForm,
    StudySourceConfigurationForm,
)
from .models import (
    Consent,
    PrivacyNotice,
...
class StudyParticipantAdmin(admin.ModelAdmin):
    ...
    def send_email_view(self, request, object_id):
        ...
        form_kwargs = {
            ...
            if participant.study.contact_email
            else [],
    ...
    def _send_email_to_participant(
        self, study_participant, subject, message, reply_to=None
    ):
...
class StudySourceConfigurationAdmin(admin.ModelAdmin):
    ...
    def get_fields(self, request, obj=None):
        ...
        config_form = (
            DataSource.get_config_form_class_for_type(obj.source_type) if obj else None
        )
        if config_form:
...
class VersionedTextAdmin(admin.ModelAdmin):
    """Base admin for versioned legal text.
